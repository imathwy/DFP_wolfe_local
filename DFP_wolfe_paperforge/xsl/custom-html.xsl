...
<xsl:stylesheet
  ...
  <xsl:import href="core-local/html.xsl"/>
  ...
  <!-- The instance publishes a source-level declaration index under
       /formalizations/ until a doc-gen4 subset is available.  The value is
       relative to the generated /paper/ page. -->
  <xsl:param name="lean.docs.root" select="'../formalizations/'"/>
  <xsl:param name="lean.docs.default.project" select="'DFPWolfe'"/>
